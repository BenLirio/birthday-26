...
export const friendTypes: { [key: string]: FriendStats } = {
  ...
  tony: {
    ...
    color: '#9C27B0',
    special: 'moveable',
    strong: ['intern', 'coworker'],
    weak: ['boss', 'karen', 'networker'],
  ...
  sophia: {
    ...
    color: '#FF9800',
    special: 'listener',
    strong: ['oversharer', 'elderly'],
    weak: ['intern', 'performer'],
  ...
  max: {
    ...
    strong: ['performer', 'gymguy'],
    weak: ['boss', 'karen', 'uncle'],
  ...
  junior: {
    ...
    strong: ['elderly', 'uncle', 'bartender'],
    weak: ['intern', 'performer'],
  ...
  sao: {
    ...
    color: '#00BCD4',
    special: 'slow_only',
    strong: ['intern', 'performer', 'elevator'],
    weak: ['boss', 'karen'],
  ...
  po: {
    ...
    strong: ['neighbor', 'uber', 'clerk'],
    weak: ['boss', 'networker', 'karen'],
  ...
  wrenly: {
    ...
    strong: ['neighbor', 'clerk', 'uber', 'elderly'],
    weak: ['boss', 'karen'],
  ...
  drea: {
    ...
    color: '#00BCD4',
    special: 'fasttalk',
    strong: ['neighbor', 'clerk'],
    weak: ['boss', 'uncle', 'bartender'],
  ...
  aviva: {
    ...
    strong: ['performer', 'elderly', 'neighbor'],
    weak: ['boss', 'networker'],
  ...
  oise: {
    ...
    strong: ['gymguy', 'performer', 'elevator'],
    weak: ['elderly', 'networker'],
...
export const enemyTypes: { [key: string]: EnemyStats } = {
  neighbor: {
    ...
    icon: '🏠',
    desc: 'Wants to talk about the weather and property values.',
    category: 'gullible',
  },
  clerk: {
    health: 25,
    ...
    name: 'Retail Clerk',
    icon: '🛍️',
    desc: 'Did you find everything you need today?',
    category: 'gullible',
  },
  uber: {
    health: 35,
    ...
    name: 'Uber Driver',
    icon: '🚗',
    desc: 'Trapped audience who wants to share life philosophy.',
    category: 'gullible',
  },
  performer: {
    health: 40,
    ...
    icon: '🎭',
    desc: 'High energy entertainer demanding audience participation.',
    category: 'energetic',
  },
  elderly: {
    health: 50,
    ...
    icon: '👴',
    desc: 'Has many stories from "back in my day".',
    category: 'patient',
  },
  gymguy: {
    health: 55,
    ...
    name: 'Gym Regular',
    icon: '💪',
    desc: 'Wants to discuss your workout routine and protein intake.',
    category: 'energetic',
  },
  boss: {
    health: 80,
    ...
    name: 'Boss',
    icon: '💼',
    desc: 'Needs to circle back and touch base about synergies.',
  ...
  evangelist: {
    ...
    name: 'Evangelist',
    icon: '📖',
    desc: 'Very persistent about sharing good news.',
    category: 'persistent',
  },
  oversharer: {
    health: 60,
    ...
    name: 'Oversharer',
    icon: '😭',
    desc: 'Dumps entire relationship history on strangers.',
    category: 'emotional',
  },
  networker: {
    health: 75,
    ...
    socialDamage: 3,
    color: '#80CBC4',
    name: 'Networking Enthusiast',
    icon: '🤝',
    desc: 'Wants to grab coffee and ideate some solutions.',
    category: 'professional',
  },
  bartender: {
    health: 85,
    ...
    name: 'Bartender',
    icon: '🍺',
    desc: 'Professional conversationalist with endless small talk.',
    category: 'patient',
  },
  coworker: {
    health: 65,
    ...
    socialDamage: 2,
    color: '#B39DDB',
    name: 'Bad Code Coworker',
    icon: '💻',
    desc: 'Submits terrible code and wants you to fix it.',
    category: 'nerdy',
  },
  intern: {
    health: 45,
    ...
    socialDamage: 2,
    color: '#FFCC80',
    name: 'Clueless Intern',
    icon: '🤷',
    desc: 'Asks endless questions and follows you around.',
    category: 'nerdy',
  },
  elevator: {
    health: 40,
    ...
    socialDamage: 1.5,
    color: '#D1C4E9',
    name: 'Elevator Person',
    icon: '🏢',
    desc: 'Awkward small talk in confined vertical space.',
    category: 'fast',
  },
  uberboss: {
    health: 200,
    ...
    icon: '🚙',
    desc: 'Ultimate captive audience nightmare with strong opinions.',
    category: 'boss',
  },
  karen: {
    health: 250,
    ...
    socialDamage: 7,
    color: '#AD1457',
    name: 'Karen Manager Meeting',
    icon: '👩‍💼',
    desc: 'Meeting that could have been an email but wants face time.',
    category: 'boss',
  },
  uncle: {
    health: 220,
    ...
    socialDamage: 6,
    color: '#5D4037',
    name: 'Family Reunion Uncle',
    icon: '👨‍🦳',
    desc: 'Strong political opinions and vacation slideshow ready.',
    category: 'boss',
  },
};
...
export const waveConfigs: WaveConfig[] = [
  {
    enemies: ['neighbor', 'clerk'],
    count: 3,
    name: 'Monday Morning',
    desc: 'Just some basic social interactions to start the day.',
  },
  {
    enemies: ['neighbor', 'clerk', 'uber'],
    count: 4,
    name: 'Grocery Run',
    desc: 'Running errands exposes you to more people.',
  },
  {
    enemies: ['performer', 'elderly'],
    count: 4,
    name: 'Park Walk',
    desc: 'Street performers and chatty elderly folks.',
  },
  {
    enemies: ['gymguy', 'performer', 'clerk'],
    count: 5,
    name: 'Gym Time',
    desc: 'That regular who always talks about reps.',
  },
  {
    enemies: ['boss', 'coworker'],
    count: 3,
    name: 'Work Meeting',
    desc: 'Corporate buzzwords incoming!',
  },
  {
    enemies: ['evangelist', 'oversharer', 'neighbor'],
    count: 5,
    name: 'Community Event',
    desc: 'People really want to share their feelings.',
  },
  {
    enemies: ['bartender', 'networker'],
    count: 4,
    name: 'Happy Hour',
    desc: 'Professional social pressure intensifies.',
  },
  {
    enemies: ['intern', 'coworker', 'boss'],
    count: 5,
    name: 'Code Review',
    desc: 'Why did the intern submit 200 lines of console.log?',
  },
  {
    enemies: ['elevator', 'elevator', 'networker'],
    count: 4,
    name: 'Office Building',
    desc: 'Awkward elevator small talk multiplied.',
  },
  {
    enemies: ['uberboss'],
    count: 1,
    name: 'Rush Hour Nightmare',
    desc: 'Trapped in a car with a chatty driver.',
  },
  {
    enemies: ['elderly', 'oversharer', 'uncle'],
    count: 4,
    name: 'Family Gathering',
    desc: 'Uncle has strong opinions about everything.',
  },
  {
    enemies: ['karen'],
    count: 1,
    name: 'Corporate Meeting',
    desc: 'A meeting that could have been an email.',
  },
];
...
export const upgradeOptions: { [key: string]: UpgradeOption } = {
  ...
  convert: {
    name: 'True Believer',
    cost: 70,
    desc: 'Converts enemies to fight for you',
    icon: '🧠',
  },
  charm: {
    name: 'Irresistible Charm',
    cost: 65,
    desc: 'Charms enemies to walk backward',
    icon: '😍',
  },
  caffeine: { name: 'Infinite Caffeine', cost: 55, desc: 'Never stops talking', icon: '☕' },
  trains: {
    name: 'Train Encyclopedia',
    cost: 70,
    desc: 'Double train rampage power and trains!',
    icon: '🚂',
  },
  ...
  experience: {
    ...
    cost: 65,
    desc: 'Starts with 5 experience levels',
    icon: '🎓',
  },
  wisdom: {
    name: 'Ancient Wisdom',
    cost: 70,
    desc: 'Max experience gives massive damage boost',
    icon: '🧠',
  },
  harmony: {
    name: 'Perfect Harmony',
    cost: 60,
    desc: 'Stuns last longer and affect more enemies',
    icon: '🎵',
  },
  volume: {
    name: 'Amplified Voice',
    cost: 55,
    desc: 'Singing range and damage increased',
    icon: '🔊',
  },
  repertoire: {
    name: 'Full Repertoire',
    cost: 70,
    desc: 'Multiple song effects and faster cooldown',
    icon: '🎼',
  },
  strength: {
    name: 'Wrestling Training',
    cost: 65,
    desc: 'Can grapple multiple enemies at once',
    icon: '💪',
  },
  grapple: {
    name: 'Master Grappler',
    cost: 60,
    desc: 'Longer grapple duration and stronger hold',
    icon: '🤼',
  },
  listening: {
    name: 'Active Listening',
    cost: 55,
    desc: 'Heals nearby friends while grappling',
    icon: '👂',
  },
};
